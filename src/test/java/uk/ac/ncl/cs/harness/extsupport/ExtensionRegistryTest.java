...
public class ExtensionRegistryTest extends TestCase {
    ...
    public ExtensionRegistryTest(String testName) {
        super(testName);
    }
    ...
    public void testRegistry() throws ConfigurationException {
        Graph g = ExtensionRegistry.getInstance().getGraphImplementation("mapgraph");
        g.createNode("test");
    }
