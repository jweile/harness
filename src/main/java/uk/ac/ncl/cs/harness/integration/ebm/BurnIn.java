...
public class BurnIn {
     ...
     */
    private Map<Graph,Integer> graphIndices;
     ...
     */
    public boolean record(Map<Graph,ErrorRates> rates) {
     ...
     */
    private void lazyInitGraphIndexMap(Set<Graph> graphs) {

        if (graphIndices == null) {
            graphIndices = new HashMap<Graph,Integer>(graphs.size());
            int i = 0;
            for (Graph g : graphs) {
