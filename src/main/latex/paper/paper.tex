...
\note{TODO: Show some stats on the integration of real data}
...
\caption{Histogram of existence probabilities for the interactions in the integrated PPI/GI dataset.}
\label{htp}
\end{figure}
